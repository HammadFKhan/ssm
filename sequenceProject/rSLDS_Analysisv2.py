...
loaded = np.load(r"Y:\Hammad\Ephys\SeqProject\ForceField\rsldsSpks_sessions\rslds_models\Mouse4_Day13_DLS_Spikes_rsldsSpks_rsldsModel.npz",allow_pickle=True)
...
spike_data = spk_noeffort_flatten
